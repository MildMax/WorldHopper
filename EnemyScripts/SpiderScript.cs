...
public class SpiderScript : EnemyBase
{
    ...
    //for the timer to have the spider move at random intervals
    ...
    {
        if (isDead == false && walkTime >= wTimer)
        {
            anim.SetBool("IsWalking", true);
            walkMethod();
        }
        else if(isDead == false && wTimer > walkTime)
        {
    ...
    void Update()
    {
        ...
        else if(isDead == false && waitTime <= wTimer)
        {
    ...
    private void SetTimer()
    {
        ...
        waitTime = walkTime + Random.Range(minWait, maxWait);
    }
